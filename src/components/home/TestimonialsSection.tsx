...
const demoTestimonials: Review[] = [
  {
    ...
    content: 'From the moment we landed, Voyages Lanka took care of everything. The attention to detail, local insights, and genuine care for our experience made this the best trip we\'ve ever taken.',
  ...
  },
  {
    ...
    content: 'We chose Voyages Lanka for our honeymoon and it was the best decision. Every romantic dinner, private tour, and special moment was perfectly arranged.',
